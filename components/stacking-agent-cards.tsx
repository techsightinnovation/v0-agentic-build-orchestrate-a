...
const AGENTS = [
  {
    label: "REAL ESTATE",
    title: "Property & client automation",
    desc: "Automate listing copy, qualify and route leads, and process tenancy and title documents — so brokers spend time selling, not on paperwork.",
    stats: [{ v: "60%", l: "faster listings" }, { v: "3x", l: "leads handled" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
  {
    label: "LOGISTICS",
    title: "Supply chain & operations",
    desc: "Forecast inventory, optimize routes, and auto-generate operational reports across distribution and trading businesses.",
    stats: [{ v: "28%", l: "cost reduction" }, { v: "24/7", l: "tracking" }],
  ...
  },
  {
    ...
    desc: "Predict demand, personalize marketing, and surface customer trends so retailers reduce stockouts and grow basket size.",
    stats: [{ v: "40%", l: "fewer stockouts" }, { v: "5x", l: "faster reports" }],
  ...
  },
  {
    ...
    desc: "Draft documents, review contracts, and automate bookkeeping and client reporting for firms that bill by the hour.",
    stats: [{ v: "70%", l: "admin saved" }, { v: "12h", l: "reclaimed/week" }],
